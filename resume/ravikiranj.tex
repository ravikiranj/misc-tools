...
\begin{itemize}
\item{Worked on identifying fiber crossings in white matter of the brain under \textit{Dr. Martin Styner (styner@cs.unc.edu)}}
\item{The main goal of my research is to find the fiber crossing landmarks and use it for registration of human brains}
\item{In particular, this research work will help in registering Krabbe disease infected human brains to normal human brains which inturn helps in the treatment procedure}
\end{itemize}}
...
\cvline{Concepts}{ Digital Image Processing, Computer Vision, Data Mining, Motion Planning for Robots, Operating Systems, Algorithms and Data Structures}
